...
const AsideMenu = ({ menuIsOpen, handleOpenSideBarMenu }: AsideMenuProps) => {
  ...
  function handleOpenSubmenu(e: React.MouseEvent) {
    ...
    const numberOfElementInNavTree =
      e.currentTarget?.parentElement?.parentElement?.children.length  as number;
    ...
    >
      ...
      <div className={styles.profile}>
        ...
        <div className={styles.profileDetails}>
          <h2>{user?.name}</h2>
          <p>{roles[user?.role as string]}</p>
        </div>
      </div>
      <nav>
        <ul>
          <h3 className={styles.sectionMenu}>Geral</h3>
          <li>
            <Link href="/">
              <a
          ...
          <h3 className={styles.sectionMenu}>Site</h3>
          ...
          <h3 className={styles.sectionMenu}>Trabalhos</h3>
          <li className={styles.linkContainer}>
            <button
              onClick={(e) => handleOpenSubmenu(e)}
              className={`${styles.linkAsideMenu} ${
          ...
          <h3 className={styles.sectionMenu}>Outros</h3>
          <li className={styles.linkContainer}>
            <button
              onClick={(e) => handleOpenSubmenu(e)}
              className={`${styles.linkAsideMenu} ${
